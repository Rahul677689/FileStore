...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('⚡️ UPDATE', url='https://t.me/RS_Movie'),
                    InlineKeyboardButton('🍁 MOVIE', url='https://t.me/+uKjVMjAHOCc5MThl')
                ]
            ]
        )
